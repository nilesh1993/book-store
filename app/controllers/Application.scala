...
object add extends addController(defaultJadeRenderer)

object delete extends deleteController(defaultJadeRenderer)

object search extends searchController(defaultJadeRenderer)

object update extends updateController(defaultJadeRenderer)